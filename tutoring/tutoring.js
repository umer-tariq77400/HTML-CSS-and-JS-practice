...
class ExtendedUser extends User{
    ...
    set fullName(name){
        ...
        if (parts.length === 2){
            ...
            console.error("Full name must contain exactly two parts: name and surname.");
        }
    }
    ...
    static match(teacher, student, course) {
        ...
        if (course) {
            ...
            if (match) {
                ...
                console.error(`Course ${course} not found for teacher ${teacher.fullName}`);
                return undefined;
            }
        }
        else {
            ...
            for (let studentCourse of student.courses) {
                let match = teacher.courses.find(c => c.course === studentCourse.course);
